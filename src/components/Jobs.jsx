        ...
        <div>
          <div className=" bg bg-slate-100 w-80 h-96 p-6 m-auto rounded">
            ...
            <div className="flex py-3">
              <img className="h-7" src="https://i.ibb.co/gWbWKZ7/Frame.png" alt="" />
              <h1 className="text-xl font-semibold pl-1">Salary :
              <span className="font-normal pl-1">{salary}</span></h1>
            </div>

            <div className="flex">
              <img className="h-7" src="https://i.ibb.co/ryR15tf/Frame-1.png" alt="" />
            ...
            <div className="flex pt-3">
              <img className="h-7" src="https://i.ibb.co/BKQnccG/Frame-2.png" alt="" />
            ...
            <div className="flex py-3">
              <img className="h-7" src="https://i.ibb.co/r3PcSMP/Frame-3.png" alt="" />
            ...
            <div className="flex">
              <img className="h-7" src="https://i.ibb.co/cXVd5Pn/Frame-4.png" alt="" />
