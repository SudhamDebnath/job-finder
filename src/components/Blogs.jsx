  ...
  return (
    <div>
      ...
      <article className="max-w-2xl px-6 py-24 mx-auto space-y-12  text-black">
        ...
        <div className="dark:dark:text-gray-800 flex justify-around items-center">
          <img
            src="https://source.unsplash.com/500x500/?portrait"
            alt="Random Images"
            className="self-center flex-shrink-0 w-24 h-24 rounded-xl md:justify-self-start dark:dark:bg-gray-800"
          />

          <p className="text-xl dark:dark:text-gray-800">
            by
            <a
              rel="noopener noreferrer"
              href="#"
              target="_blank"
              className=" m-2 underline dark:dark:text-violet-800"
            >
